...
END CATCH
GO
PRINT N'Creating [log].[Log_StartOfPackage]...';


GO
CREATE PROCEDURE [log].[Log_StartOfPackage]
	@AppInstanceID	INT
...
END CATCH
GO
PRINT N'Creating [log].[Get_ExecutionErrors]...';


GO
CREATE PROC [log].[Get_ExecutionErrors] 
	@AppInstanceId INT 
...
END CATCH
GO
PRINT N'Creating [log].[Log_ApplicationFailure]...';


GO
CREATE PROCEDURE [log].[Log_ApplicationFailure]
	@AppInstanceID INT
AS
BEGIN TRY
...
END CATCH
GO
PRINT N'Creating [log].[Log_ApplicationSuccess]...';


GO
CREATE PROCEDURE [log].[Log_ApplicationSuccess]
	@AppInstanceID INT
...
END CATCH
GO
PRINT N'Creating [log].[Log_Error]...';


GO
CREATE PROCEDURE [log].[Log_Error]
	@AppInstanceID		INT
,	@PkgInstanceID		INT
...
END CATCH
GO
PRINT N'Creating [log].[Log_Event]...';


GO
CREATE PROCEDURE [log].[Log_Event]
	@AppInstanceID		INT
,	@PkgInstanceID		INT
,	@SourceName			VARCHAR (255)
...
END CATCH
GO
PRINT N'Creating [log].[Log_PackageFailure]...';


GO
CREATE PROCEDURE [log].[Log_PackageFailure]
@PkgInstanceID INT
...
END CATCH
GO
PRINT N'Creating [log].[Log_PackageSuccess]...';


GO
CREATE PROCEDURE [log].[Log_PackageSuccess]
@PkgInstanceID INT
AS
...
END CATCH
GO
PRINT N'Creating [log].[Log_StartOfApplication]...';


GO
CREATE PROCEDURE [log].[Log_StartOfApplication]
	@ApplicationName VARCHAR (255)
AS

...
exec @stgPackageId = [cfg].AddSSISPackage 'Merge_dbo_tblDashBoardAmount_Banked.dtsx', '' ;-- Folder name not needed for SSIS Catalog
SET @stgExecutionOrder += 10;
exec [cfg].[AddSSISProjectPackage] @stgProjectId, @stgPackageId, @stgExecutionOrder, 'I', 'F', 1;
...
;WITH CTE AS	(
				...
				FROM	(
						...
						UNION
							SELECT 8, 'mobile', 'tblDashboardAmount (Banked)', 0, GETDATE(), PackageId FROM cfg.Packages WHERE PackageName = 'Merge_dbo_tblDashBoardAmount_Banked.dtsx'
						) AS ctTable
